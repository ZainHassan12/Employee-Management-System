...
class Add_Coordinator extends StatefulWidget {
  const Add_Coordinator({Key? key}) : super(key: key);

  @override
  State<Add_Coordinator> createState() => _Add_CoordinatorState();
}

class _Add_CoordinatorState extends State<Add_Coordinator> {
          ...
          SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                textformfield("ID (@CO.en)", "ID", idController),
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: ()async {
                      ...
                      if (id.isEmpty) {
                        ...
                        CollectionReference collection = FirebaseFirestore.instance.collection('Manager');
