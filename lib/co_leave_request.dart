...
class CoComposeRequest extends StatefulWidget {
  const CoComposeRequest({super.key});

  @override
  _CoComposeRequest createState() => _CoComposeRequest();
}

class _CoComposeRequest extends State<CoComposeRequest> {
  ...
  void submitLeaveRequest() async {
    ...
    final DocumentReference leaveDocRef = await FirebaseFirestore.instance.collection('Manager').doc(User.Id).collection('leaveRequests').add({
