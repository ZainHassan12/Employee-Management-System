...
class CoordinatorInfo extends StatefulWidget {
  const CoordinatorInfo({Key? key}) : super(key: key);

  @override
  State<CoordinatorInfo> createState() => _CoordinatorInfoState();
}

class _CoordinatorInfoState extends State<CoordinatorInfo> {
                                    ...
                                    if (result != null) {
                                      switch (result) {
                                        ...
                                        case 'Salary':
                                          ...
                                          break;
                                        case 'Remove':
                                          if(User.designation == 'CEO'|| User.designation == 'CFO' || User.designation == 'COO') {
                                            showDialog<void>(
                                              context: context,
                                            ...
                                            showDialog(
                                                ...
                                                builder: (BuildContext){
                                                  return const AlertDialog(
                                                    title: Text('Oops!', style: TextStyle(color: Colors.orange),),
                                                    content: Text('You are not allowed to remove Manager'),
                                                  );
                                                }
                                            );
                                          }
