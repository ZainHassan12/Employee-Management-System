...
class EmpAttendance extends StatefulWidget {
  ...
  @override
  State<EmpAttendance> createState() => _EmpAttendance();
}

class _EmpAttendance extends State<EmpAttendance> {
  ...
  void getCount() async {
    try {
        ...
        .collection('Sales & Support').doc(snap.docs[0].id)
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (context) {
                                            return AlertDialog(
                                              title: const Text("Performance", style: TextStyle(color: Colors.orange),),
                                              content: Text(
                                                snap[index]['performance'],
                                              ),
                                            );
                                          },
                                        );
