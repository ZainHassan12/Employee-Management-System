...
class EmpRequests extends StatefulWidget {
  final User user;
  const EmpRequests({super.key, required this.user});


  @override
  State<EmpRequests> createState() => _EmpRequestsState();
}

class _EmpRequestsState extends State<EmpRequests> {
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: StreamBuilder<QuerySnapshot>(
                      stream: FirebaseFirestore.instance.collection('Sales & Support').doc(id).collection('leaveRequests').snapshots(),
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index){
                              ...
                              if(snap[index]['Status'] == 'Approved') {
                                mycol = Colors.green;
                                status = 'Approved by';
                                stat = snap[index]['Approved or Rejected by'];
