...
class EmpAllRequests extends StatefulWidget {
  const EmpAllRequests({Key? key}) : super(key: key);

  @override
  State<EmpAllRequests> createState() => _EmpAllRequestsState();
}

class _EmpAllRequestsState extends State<EmpAllRequests> {
                            ...
                            return Column(
                              children: leave.map((DocumentSnapshot leaveDoc) {
                                ...
                                if(leaveDoc['Status'] == 'Approved') {
                                  mycol = Colors.green;
                                  status = 'Approved by';
                                  stat = leaveDoc['Approved or Rejected by'];
