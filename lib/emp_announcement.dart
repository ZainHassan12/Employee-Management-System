...
class EmpAnnouncement extends StatefulWidget {
  const EmpAnnouncement({Key? key}) : super(key: key);

  @override
  State<EmpAnnouncement> createState() => _EmpAnnouncementState();
}

class _EmpAnnouncementState extends State<EmpAnnouncement> {
                                          ...
                                          snap[index]['isChecked'] == false? Padding(
                                            ...
                                            child: ElevatedButton(
                                              onPressed: (){
                                                ...
                                                FirebaseFirestore.instance.collection("Sales & Support")
