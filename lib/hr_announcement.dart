...
class HrAnnouncement extends StatefulWidget {
  const HrAnnouncement({Key? key}) : super(key: key);

  @override
  State<HrAnnouncement> createState() => _HrAnnouncementState();
}

class _HrAnnouncementState extends State<HrAnnouncement> {
